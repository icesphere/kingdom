<div class="cardName" style="<#if clickType=='supply' && gameStatus == "InProgress" && supply(card.name) == 0><#else><#if card.type.typeId == 7>background-image: url(images/grey_green_mobile.gif);background-repeat: repeat-x;<#elseif card.type.typeId == 8>background-image: url(images/gold_green_mobile.gif);background-repeat: repeat-x;<#elseif card.type.typeId == 10>background-image: url(images/gold_purple_mobile.gif);background-repeat: repeat-x;<#elseif card.type.typeId == 11>background-image: url(images/green_blue_mobile.gif);background-repeat: repeat-x;<#elseif card.type.typeId == 12>background-image: url(images/orange_green_mobile.gif);background-repeat: repeat-x;<#elseif card.type.typeId == 14>background-image: url(images/gold_blue_mobile.gif);background-repeat: repeat-x;<#else>background-color:${card.backgroundColorColor};</#if></#if>">
    ...
    <#if (clickType=="supply" || clickType=="admin") && gameStatus == "InProgress"><div style="position:absolute;right:2px;font-size:10px;bottom:2px;">${supply(card.name)}</div></#if>
    <#if (card.victory || card.curse) && card.victoryPoints !=0>
        <#if card.type.typeId == 8 || card.type.typeId == 10>
