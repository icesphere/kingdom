...
<#if card.prophecy && sunTokens??>
    <div style="position:absolute; left:2px; bottom:0; color:#6A4200; background-color:#FFF4BE; border:1px solid #C98A00; border-radius:5px; padding:1px 2px; font-size:9px; font-weight:bold; line-height:10px;">${sunTokenDisplay}</div>
</#if>
<#if card.debtCost != 0>
