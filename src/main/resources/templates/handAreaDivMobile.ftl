<div style="float:left;clear:both;">
    ...
    <#if showExileCards>
        <div class="handAreaTopRowLeft" style="clear:both;"><#if player.exileCards?size != 0><a href="javascript:showExileCards()"></#if>${player.exileCards?size} Exile Card<#if player.exileCards?size != 1>s</#if><#if player.exileCards?size != 0></a></#if></div>
    </#if>
    ...
    <#if player.villagers != 0>
        <div class="handAreaTopRowLeft" style="clear:both;"><a href="javascript:useVillagers()">${player.villagers} Villager<#if player.villagers != 1>s</#if></a></div>
    </#if>
    <#if player.favors != 0>
        <div class="handAreaTopRowLeft" style="clear:both;">${player.favors} Favor<#if player.favors != 1>s</#if></div>
    </#if>
