    ...
    public static void handleCardAction(CardAction cardAction, ComputerPlayer computer) {
        ...
        if (cardName.equals("Followers")) {
            ...
            if (type == CardAction.TYPE_DISCARD_FROM_HAND) {
                CardActionHandler.INSTANCE.handleSubmittedCardAction(game, player, computer.getCardsToDiscard(cardAction.getCards(), 1), null, null, -1);
            } else {
            ...
            if (type == CardAction.TYPE_DISCARD_FROM_HAND) {
                ...
                CardActionHandler.INSTANCE.handleSubmittedCardAction(game, player, null, null, "reveal", -1);
            }
        } else {
