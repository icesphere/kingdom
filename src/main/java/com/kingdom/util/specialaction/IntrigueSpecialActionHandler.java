...
public class IntrigueSpecialActionHandler {
    public static IncompleteCard handleSpecialAction(Game game, Card card) {
        ...
        else if (card.getName().equals("Courtyard")) {
            Player player = game.getCurrentPlayer();
        ...
        else if (card.getName().equals("Ironworks")) {
            Player player = game.getCurrentPlayer();
        ...
        else if (card.getName().equals("Masquerade")) {
        ...
        else if (card.getName().equals("Mining Village")) {
            Player player = game.getCurrentPlayer();
            CardAction cardAction = new CardAction(CardAction.TYPE_YES_NO);
            cardAction.setDeck(Card.DECK_INTRIGUE);
            cardAction.setCardName(card.getName());
        ...
        else if (card.getName().equals("Minion")) {
            Player player = game.getCurrentPlayer();
        ...
        else if (card.getName().equals("Pawn")) {
            Player player = game.getCurrentPlayer();
            CardAction cardAction = new CardAction(CardAction.TYPE_CHOICES);
            cardAction.setDeck(Card.DECK_INTRIGUE);
            cardAction.setCardName(card.getName());
        ...
        else if (card.getName().equals("Saboteur")) {
        ...
        else if (card.getName().equals("Scout")) {
            Player player = game.getCurrentPlayer();
        ...
        else if (card.getName().equals("Shanty Town")) {
            Player player = game.getCurrentPlayer();
        ...
        else if (card.getName().equals("Steward")) {
            Player player = game.getCurrentPlayer();
            CardAction cardAction = new CardAction(CardAction.TYPE_CHOICES);
            cardAction.setDeck(Card.DECK_INTRIGUE);
            cardAction.setCardName(card.getName());
        ...
        else if (card.getName().equals("Swindler")) {
        ...
        else if (card.getName().equals("Torturer")) {
            incompleteCard = new MultiPlayerIncompleteCard(card.getName(), game, false);
            for (Player player : players) {
                if (player.getUserId() != currentPlayerId) {
                    if (game.isCheckEnchantedPalace() && game.revealedEnchantedPalace(player.getUserId())) {
        ...
        else if (card.getName().equals("Trading Post")) {
            Player player = game.getCurrentPlayer();
        ...
        else if (card.getName().equals("Tribute")) {
            Player player = game.getCurrentPlayer();
        ...
        else if (card.getName().equals("Upgrade")) {
            Player player = game.getCurrentPlayer();
            if (player.getHand().size() > 0) {
                CardAction cardAction = new CardAction(CardAction.TYPE_TRASH_CARDS_FROM_HAND);
                cardAction.setDeck(Card.DECK_INTRIGUE);
        ...
        else if (card.getName().equals("Wishing Well")) {
            Player player = game.getCurrentPlayer();
